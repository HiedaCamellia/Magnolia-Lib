...
public class MagnoliaItem extends Item {
    ...
    public MagnoliaItem(Item.Properties properties) {
        super(properties);
    ...
    public int getUseDuration(ItemStack stack, LivingEntity entity) {
        ...
        return foodproperties != null ? useDuration : 0;
    }
    ...
    public UseAnim getUseAnimation(ItemStack stack) {
        return stack.has(DataComponents.FOOD) ? useAction : UseAnim.NONE;
    }
