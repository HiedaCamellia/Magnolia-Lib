...
public class MagnoliaItems {
    public static final ResourceKey<BannerPattern> PENGUIN_PATTERN_KEY = ResourceKey.create(Registries.BANNER_PATTERN, MagnoliaLib.prefix("penguin"));
    public static final TagKey<BannerPattern> REQUIRES_PENGUIN_ITEM = TagKey.create(Registries.BANNER_PATTERN, MagnoliaLib.prefix("requires_penguin_item"));
    public static final DeferredRegister.Items ITEMS = DeferredRegister.createItems(MagnoliaLib.MODID);
    public static final DeferredRegister<BannerPattern> BANNER_PATTERNS = DeferredRegister.create(Registries.BANNER_PATTERN, MagnoliaLib.MODID);
    ...
    public static final DeferredHolder<BannerPattern, BannerPattern> PENGUIN_PATTERN = BANNER_PATTERNS.register("penguin", () -> new BannerPattern(MagnoliaLib.prefix("pgn"),"pgn"));
