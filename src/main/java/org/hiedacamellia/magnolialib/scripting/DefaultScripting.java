package org.hiedacamellia.magnolialib.scripting;
...
import org.hiedacamellia.magnolialib.event.ScriptingEvents;
import org.hiedacamellia.magnolialib.scripting.wrapper.*;
import org.hiedacamellia.magnolialib.util.helper.FakePlayerHelper;
...
public class DefaultScripting {
    ...
    public static void onCollectWrappers(ScriptingEvents.CollectWrapper event) {
        ...
        event.register(TeamJS.class, MagnoliaTeam.class).setSided();
