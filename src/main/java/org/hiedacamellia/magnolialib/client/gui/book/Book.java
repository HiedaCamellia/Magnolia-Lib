package org.hiedacamellia.magnolialib.client.gui.book;
...
import org.hiedacamellia.magnolialib.client.gui.AbstractContainerScreen;
import org.hiedacamellia.magnolialib.client.gui.book.page.AbstractPage;
import org.hiedacamellia.magnolialib.client.gui.book.tab.Tab;
import org.hiedacamellia.magnolialib.world.inventory.AbstractBookMenu;
...
public class Book extends AbstractContainerScreen<AbstractBookMenu> {
    ...
    public Book(String modid, AbstractBookMenu container, Inventory inv, Component name) {
        ...
        backgroundL = MagnoliaLib.prefix("textures/gui/book_left.png");
        backgroundR = MagnoliaLib.prefix("textures/gui/book_right.png");
    }
